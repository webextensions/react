...
printf "\n";
printf "\n${BLUE}If you are installing \"@webextensions/react\" as a package, then:${NORMAL}";
printf "\n     To list its peerDependencies:";
printf "\n         $ npm info \"@webextensions/react\" peerDependencies";
printf "\n         And add these dependencies to your project's package.json file";
printf "\n     To install its peerDependencies:";
printf "\n         $ npx install-peerdeps --dev @webextensions/react";
printf "\n\n";
